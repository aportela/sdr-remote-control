...
#define _DIGITAL_SEMETER_WIDGET_VERTICAL_LINES_LENGTH 23
#define _DIGITAL_SEMETER_WIDGET_VERTICAL_LINES_Y_OFFSET 22
#define _DIGITAL_SEMETER_WIDGET_LEFT_VERTICAL_LINE_X_OFFSET 0
#define _DIGITAL_SEMETER_WIDGET_RIGHT_VERTICAL_LINE_X_OFFSET (_DIGITAL_SMETER_WIDGET_BAR_HORIZONTAL_MARGIN * 2) + (_DIGITAL_SMETER_WIDGET_BAR_COUNT * (_DIGITAL_SMETER_WIDGET_BAR_HORIZONTAL_MARGIN + SMETER_BAR_WIDTH))
#define _DIGITAL_SEMETER_WIDGET_HORIZONTAL_LINE_X_OFFSET _DIGITAL_SEMETER_WIDGET_LEFT_VERTICAL_LINE_X_OFFSET
#define _DIGITAL_SEMETER_WIDGET_HORIZONTAL_LINE_Y_OFFSET 116
#define _DIGITAL_SEMETER_WIDGET_HORIZONTAL_LINE_LENGTH 262

// bars
#define _DIGITAL_SMETER_WIDGET_BAR_COUNT 38
#define _DIGITAL_SMETER_WIDGET_BAR_HORIZONTAL_MARGIN 4
#define _DIGITAL_SMETER_WIDGET_BARS_X_OFFSET _DISPLAY_PADDING + _DIGITAL_SMETER_WIDGET_BAR_HORIZONTAL_MARGIN + 1

// top value labels
#define _DIGITAL_SMETER_WIDGET_TOP_LABELS_X_OFFSET _DIGITAL_SEMETER_WIDGET_LEFT_VERTICAL_LINE_X_OFFSET + _DIGITAL_SMETER_WIDGET_BAR_HORIZONTAL_MARGIN
#define _DIGITAL_SMETER_WIDGET_TOP_LABELS_Y_OFFSET 0

// public widget constants
#define DIGITAL_SMETER_WIDGET_WIDTH DISPLAY_WIDTH - (_DISPLAY_PADDING * 2)
#define DIGITAL_SMETER_WIDGET_HEIGHT 48
