...
const RadioBand RadioBands[] = {
    ...
    {RBR_REGION_1, RBT_AMATEUR, "20m", 14000000, 14350000, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "15m", 21000000, 21450000, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "10m", 28000000, 29700000, TRX_VFO_MD_USB},
