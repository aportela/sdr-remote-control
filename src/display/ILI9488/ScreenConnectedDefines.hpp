...
#define ANALOG_SMETER_WIDGET_Y_OFFSET DIGITAL_SMETER_WIDGET_Y_OFFSET + DIGITAL_SMETER_WIDGET_HEIGHT + WIDGETS_VERTICAL_MARGIN
#define ANALOG_SMETER_WIDGET_PADDING 1
#define ANALOG_SMETER_WIDGET_BACKGROUND_WIDTH 350
#define ANALOG_SMETER_WIDGET_BACKGROUND_HEIGHT ANALOG_SMETER_WIDGET_HEIGHT
#define ANALOG_SMETER_WIDGET_CENTER_HLINE_X_OFFSET 4
#define ANALOG_SMETER_WIDGET_CENTER_HLINE_Y_OFFSET ANALOG_SMETER_WIDGET_HEIGHT / 2
#define ANALOG_SMETER_WIDGET_CENTER_HLINE_LENGTH ANALOG_SMETER_WIDGET_BACKGROUND_WIDTH - 8
#define ANALOG_SMETER_WIDGET_CENTER_NUMBERS_X_OFFSET 10

#define ANALOG_SMETER_WIDGET_CENTER_METER_VLINE_Y_OFFSET ANALOG_SMETER_WIDGET_HEIGHT / 2 + 4
#define ANALOG_SMETER_WIDGET_CENTER_METER_VLINE_Y_HEIGHT 25
#define ANALOG_SMETER_WIDGET_CENTER_METER_VLINE_WIDTH 3
