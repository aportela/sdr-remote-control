...
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S3_X_OFFSET 56         // "S3" x offset
...
#define _ANALOG_SMETER_WIDGET_BAR_COUNT 39 // total smeter bars
...
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_HEIGHT 2
...
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_X_OFFSET _ANALOG_SMETER_WIDGET_CENTER_HLINE_X_OFFSET
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_Y_OFFSET (_ANALOG_SMETER_WIDGET_CENTER_HLINE_Y_OFFSET + _ANALOG_SMETER_WIDGET_CENTER_HLINE_HEIGHT)
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_WIDTH (((_ANALOG_SMETER_WIDGET_VLINES_WIDTH + _ANALOG_SMETER_WIDGET_VLINES_MARGIN) * ((_ANALOG_SMETER_WIDGET_BAR_COUNT / 2) - 1)))
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_HEIGHT 5

// right colored ("high values") horizontal bar
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_HIGH_VALUES_X_OFFSET ((_ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_X_OFFSET + _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_WIDTH))
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_HIGH_VALUES_Y_OFFSET _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_Y_OFFSET
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_HIGH_VALUES_WIDTH (((_ANALOG_SMETER_WIDGET_VLINES_WIDTH + _ANALOG_SMETER_WIDGET_VLINES_MARGIN) * ((_ANALOG_SMETER_WIDGET_BAR_COUNT / 2) + 1)) + _ANALOG_SMETER_WIDGET_VLINES_WIDTH)
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_HIGH_VALUES_HEIGHT _ANALOG_SMETER_WIDGET_CENTER_HLINE_LOW_VALUES_HEIGHT
