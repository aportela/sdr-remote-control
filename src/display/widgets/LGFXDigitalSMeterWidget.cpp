...
void LGFXDigitalSMeterWidget::drawBars(int8_t dB)
{
  for (int i = 0; i < _DIGITAL_SMETER_WIDGET_BAR_COUNT; i++)
  {
    ...
    this->fillRect(x, (isCurrentLongBar ? _DIGITAL_SMETER_WIDGET_HIGH_BAR_Y_OFFSET : _DIGITAL_SMETER_WIDGET_LOW_BAR_Y_OFFSET), _DIGITAL_SMETER_WIDGET_BAR_WIDTH, isCurrentLongBar ? _DIGITAL_SMETER_WIDGET_HIGH_BAR_HEIGHT : _DIGITAL_SMETER_WIDGET_LOW_BAR_HEIGHT, barColor);
  }
}

void LGFXDigitalSMeterWidget::init(void)
{
  uint16_t x = _DIGITAL_SMETER_WIDGET_LEFT_VERTICAL_LINE_X_OFFSET;
  // left vertical container line
  // TODO: LINES
  this->fillRect(x, _DIGITAL_SMETER_WIDGET_HIGH_BAR_Y_OFFSET, _DIGITAL_SMETER_WIDGET_VERTICAL_LINE_WIDTH, _DIGITAL_SMETER_WIDGET_VERTICAL_LINE_HEIGHT, DIGITAL_SMETER_CONTAINER_LINES_TEXT_COLOR);
  x = _DIGITAL_SMETER_WIDGET_HORIZONTAL_LINE_X_OFFSET;
  // bottom horizontal container line
  this->fillRect(x, _DIGITAL_SMETER_WIDGET_HORIZONTAL_LINE_Y_OFFSET, _DIGITAL_SMETER_WIDGET_HORIZONTAL_LINE_WIDTH, _DIGITAL_SMETER_WIDGET_HORIZONTAL_LINE_HEIGHT, DIGITAL_SMETER_CONTAINER_LINES_TEXT_COLOR);
  x = _DIGITAL_SMETER_WIDGET_RIGHT_VERTICAL_LINE_X_OFFSET;
