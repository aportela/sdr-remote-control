...
#define _VFO_WIDGET_FONT_WIDTH DEFAULT_FONT_SIZE_3_WIDTH   // total pixel width for one char on current font size
#define _VFO_WIDGET_FONT_HEIGHT DEFAULT_FONT_SIZE_3_HEIGHT // total pixel height for one char on current font size

// field offsets
#define _VFO_WIDGET_VFO_INDEX_X_OFFSET 0                                                                                       // vfo index field x offset
#define _VFO_WIDGET_FREQUENCY_X_OFFSET 86                                                                                      // frequency field x offset
...
#define _SMETER_WIDGET_SIGNAL_VALUE_LABEL_Y_OFFSET (SMETER_WIDGET_HEIGHT - _SMETER_WIDGET_SIGNAL_BASE_FONT_SIZE_HEIGHT - 3) // signal meter value label (Snn+xydB) y offset

// signal meter "S" (Sn) label x/y offsets
#define _SMETER_WIDGET_SIGNAL_BASE_LABEL_X_OFFSET (SMETER_WIDGET_WIDTH - 108)
...
#define _ANALOG_SMETER_WIDGET_BACKGROUND_WIDTH 356
#define _ANALOG_SMETER_WIDGET_BACKGROUND_HEIGHT SMETER_WIDGET_HEIGHT
...
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_LENGTH (((_ANALOG_SMETER_WIDGET_VLINES_WIDTH + _ANALOG_SMETER_WIDGET_VLINES_MARGIN) * _ANALOG_SMETER_WIDGET_BAR_COUNT) - _ANALOG_SMETER_WIDGET_VLINES_MARGIN)

#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_X_OFFSET ((_ANALOG_SMETER_WIDGET_BACKGROUND_WIDTH - _ANALOG_SMETER_WIDGET_CENTER_HLINE_LENGTH) / 2)
#define _ANALOG_SMETER_WIDGET_CENTER_HLINE_Y_OFFSET (SMETER_WIDGET_HEIGHT / 2)

#define _ANALOG_SMETER_WIDGET_SHORT_VLINES_Y_OFFSET (_ANALOG_SMETER_WIDGET_CENTER_HLINE_Y_OFFSET - 3)
#define _ANALOG_SMETER_WIDGET_LONG_VLINES_Y_OFFSET (_ANALOG_SMETER_WIDGET_CENTER_HLINE_Y_OFFSET - 10)

#define _ANALOG_SMETER_WIDGET_CENTER_SHORT_VLINES_LENGTH 3
#define _ANALOG_SMETER_WIDGET_CENTER_LONG_VLINES_LENGTH 10
...
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S_X_OFFSET 12          // "S" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S1_X_OFFSET 30         // "S1" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S3_X_OFFSET 66         // "S3" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S5_X_OFFSET 103        // "S5" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S7_X_OFFSET 139        // "S7" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S9_X_OFFSET 175        // "S9" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S9_PLUS15_X_OFFSET 200 // "S9+15" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S9_PLUS30_X_OFFSET 234 // "S9+30" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_S9_PLUS60_X_OFFSET 312 // "S9+60" x offset
#define _ANALOG_SMETER_WIDGET_TOP_RANGE_LABELS_Y_OFFSET 2             // y offset for labels of "1 3 4 7 9  +15  +30    +60"

#define _ANALOG_SMETER_WIDGET_BAR_COUNT 37 // total smeter bars
#define _ANALOG_SMETER_WIDGET_CENTER_METER_VLINE_Y_OFFSET (SMETER_WIDGET_HEIGHT / 2) + 8
