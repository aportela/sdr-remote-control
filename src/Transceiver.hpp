...
const RadioBand RadioBands[] = {
    ...
    {RBR_REGION_1, RBT_AMATEUR, "20m", 14000, 14350, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "15m", 21000, 21450, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "10m", 28000, 29700, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "6m", 50000, 52000, TRX_VFO_MD_USB},
    {RBR_REGION_1, RBT_AMATEUR, "2m", 144000, 146000, TRX_VFO_MD_FM},
    {RBR_REGION_1, RBT_AMATEUR, "70cm", 430000, 440000, TRX_VFO_MD_FM},
};
