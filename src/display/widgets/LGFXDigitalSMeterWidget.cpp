...
void LGFXDigitalSMeterWidget::init(void)
{
  ...
  this->parentDisplayPtr->fillRect(x, this->yOffset + this->padding + _DIGITAL_SMETER_WIDGET_HIGH_BAR_Y_OFFSET, _DIGITAL_SMETER_WIDGET_BAR_WIDTH, _DIGITAL_SMETER_WIDGET_HIGH_BAR_HEIGHT, DIGITAL_SMETER_CONTAINER_LINES_TEXT_COLOR);
